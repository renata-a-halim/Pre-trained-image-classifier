...
def calculates_results_stats(results_dic):
 ...
 # Calculates % correct classified breed of dogs
    results_stats_dic['n_correct_breed'] = (results_stats_dic['n_correct_breed'] / results_stats_dic['n_images']) * 100 
